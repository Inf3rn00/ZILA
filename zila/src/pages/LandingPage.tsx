...
import { Ticket, CheckCircle, Clock, BarChart3, ArrowRight, Sparkles } from "lucide-react";
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-white/20">
              ...
              <span className="text-sm font-medium">Streamline your workflow today</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300">
              <Link to="/auth/signup">
                <Button className="w-full sm:w-auto bg-white text-blue-600 hover:bg-white/90 hover:scale-105 transition-all duration-200 font-semibold px-8 py-3 text-lg shadow-lg">
                  Get Started Free
              ...
              <Link to="/auth/login">
                <Button
                  variant="outline"
                  className="w-full sm:w-auto border-2 border-white/40 text-white hover:bg-white/10 hover:border-white/60 backdrop-blur-sm transition-all duration-200 font-medium px-8 py-3 text-lg"
                >
                  Sign In
                </Button>
              </Link>
            ...
            {[
              {
                ...
                description: "Quickly create and categorize tickets with detailed information and priority levels",
              ...
              },
              {
                ...
                description: "Monitor ticket status in real-time with clear visual indicators and notifications",
              ...
              },
              {
                ...
                description: "Streamlined workflows help your team resolve issues efficiently and effectively",
              ...
              <div 
                key={index}
                className="group p-8 bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 hover:border-slate-200 hover:-translate-y-2"
              >
                ...
                <div className={`w-0 group-hover:w-12 h-1 bg-gradient-to-r ${feature.color} rounded-full mt-4 transition-all duration-300`} />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-300 mb-8 leading-relaxed">
              Join thousands of teams who are already managing their tickets more 
              efficiently and delivering better results with TicketFlow.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link to="/auth/signup">
                <Button className="bg-white text-slate-900 hover:bg-white/90 hover:scale-105 transition-all duration-200 font-semibold px-8 py-3 text-lg shadow-lg">
                  Start Free Trial
                  <ArrowRight className="ml-2 w-4 h-4" />
                </Button>
              </Link>
              <Link to="/auth/login">
                <Button
                  variant="outline"
                  className="border-2 border-white/30 text-white hover:bg-white/10 hover:border-white/50 backdrop-blur-sm transition-all duration-200 font-medium px-8 py-3 text-lg"
                >
                  Schedule Demo
                </Button>
              </Link>
